...
<?php $__env->startSection('content'); ?>
    <div class="bg-white rounded-3 container my-5  p-4 ">
        ...
        <form action="<?php echo e(route('products.store')); ?>" method="post" enctype="multipart/form-data" class="fs-5 my-4 addproduct">
            <?php echo csrf_field(); ?>
            <div class="row">
                <div class="col-8">
                    <div class="row">
                        ...
                        <div class="my-4 col-6  ">
                            ...
                            <input type="text" class="px-2 py-1 bg-light border-0 rounded my-2" id="remise"
                                name="discount">
                        </div>
                        <div class="my-4 col-6  ">
