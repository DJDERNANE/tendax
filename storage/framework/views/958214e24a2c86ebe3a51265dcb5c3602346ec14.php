                ...
                <?php if($offre->img_offre): ?>
                    <div class="my-4">
                        ...
                        <div class="d-flex justify-content-around mt-3">
                            ...
                            <a href="#" onclick="PrintImage('<?php echo e(asset('storage/' . $offre->img_offre)); ?>'); return false;">
                ...
                <?php if($offre->img_offre2): ?>
                    <div class="my-4">
                        ...
                        <div class="d-flex justify-content-around mt-3">
                            ...
                            <a href="#" onclick="PrintImage('<?php echo e(asset('storage/' . $offre->img_offre2)); ?>'); return false;">
                                <img src="<?php echo e(asset('img/icons/printer.png')); ?>" alt="">
                            </a>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body d-flex justify-content-around">
            ...
            <a class="resp-sharing-button__link" href="https://facebook.com/sharer/sharer.php?u=<?php echo e(urlencode(route('detail', $offre))); ?>" target="_blank" rel="noopener" aria-label="">
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tendaxe\resources\views/offers/detail.blade.php ENDPATH**/ ?>