                        ...
                        <ul style="list-style-type: none">
                            <li class="nav-item px-2 dropdown">
                                ...
                                <form method="POST" action="<?php echo e(route('logout')); ?>"
                                    ...
                                    <a class="dropdown-item pl-2 pr-5" href="<?php echo e(route('storePanel')); ?>">
                                        <img class="mr-2" width="25px"
                                            src="<?php echo e(asset('img/icons/stacked_doc.png')); ?>" alt="">
                                        Ma Boutique
                                    </a>
        ...
        <div class="col-md-6 col-12">
            ...
            <div class="row payment mt-4">
                <div class=" d-flex col-md-3 col-12 my-2 align-items-center bg-white mx-2 p-2">
                    <i class=" mr-4 bi bi-credit-card-2-back-fill text-primary font-weight-bold"></i>
                    <p class="mb-0">Paiement
                        par cheque</p>
                </div>
                <div class=" d-flex col-md-3 col-12 my-2 align-items-center bg-white mx-2 p-2">
                    <i class=" mr-4 bi bi-credit-card-2-back-fill text-primary font-weight-bold"></i>
