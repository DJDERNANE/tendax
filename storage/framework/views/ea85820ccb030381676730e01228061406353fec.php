    ...
    <div class="bg-white px-3 pt-3 border rounded">
        ...
        <div class="row">
            ...
            <div class="mb-2 d-flex">
                <span class="mx-auto mt-2 text-15"> <img src="<?php echo e(asset('img/icons/play.png')); ?>"> <?php echo e($offre->date_pub); ?></span>
                <span class="mx-auto mt-2 text-15"> <img src="<?php echo e(asset('img/icons/stop.png')); ?>"> <?php echo e($offre->date_limit); ?></span>
                <div>
                    <a href="<?php echo e(route('detail', $offre)); ?>" class="btn btn-sm btn-primary px-3 ml-auto">Detail</a>
                    <a href="<?php echo e(route('participer', $offre)); ?>" class="btn btn-sm btn-primary px-3 ml-auto p-0 ">Participer <i class="bi bi-microsoft-teams" style="font-size: 20px"></i></a>
                    <?php if(Auth::check() && Auth::user()->type_user === 'content'): ?>
                        <a href="<?php echo e(route('rep.offers.edit', $offre)); ?>" class="btn btn-sm btn btn-outline-info">Modifier</a>
                        <button class="btn btn-sm btn-danger" data-toggle="modal" data-target="#exampleModalCenter" data-id="<?php echo e($offre->id); ?>">Supprimer</button>
                    <?php endif; ?>
                    <?php if(Auth::check() && (Auth::user()->type_user === 'admin' || Auth::user()->type_user === 'publisher')): ?>
                        <a href="<?php echo e(route('admin.offers.edit', $offre)); ?>" class="btn btn-sm btn btn-outline-info">Modifier</a>
                        <button class="btn btn-sm btn-danger" data-toggle="modal" data-target="#exampleModalCenter" data-id="<?php echo e($offre->id); ?>">Supprimer</button>
                    <?php endif; ?>
                    <?php if(Auth::check() && Auth::user()->type_user === 'admin' && $offre->trashed()): ?>
                        <button class="btn btn-sm btn-secondary" data-toggle="modal" data-target="#restoremodal" data-id="<?php echo e($offre->id); ?>">Restore</button>
                    <?php endif; ?>
                    <?php if(Auth::check() && Auth::user()->type_user === 'admin' && $offre->etat === "pending"): ?>
                        <button class="btn btn-sm btn-success" data-toggle="modal" data-target="#acceptmodal" data-id="<?php echo e($offre->id); ?>">accepter</button>
                    <?php endif; ?>
                </div>
            </div>
        
    </div>
</div><?php /**PATH C:\xampp\htdocs\tendaxe\resources\views/components/offre.blade.php ENDPATH**/ ?>