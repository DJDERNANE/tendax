...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid px-md-5 py-5"
        style="background: url(<?php echo e(asset('img/banner/books.jpg')); ?>) no-repeat center center; margin-top: 66px; background-size: cover;">
        <div class="">
...
<?php endif; ?>
        <div class="mt-3 mb-2 text-right">
            <?php if(auth()->guard()->check()): ?>
                <a href="<?php echo e(route('offre.add')); ?>" class="btn btn-sm btn-primary px-3 font-weight-600">Ajouter Offre</a>
            <?php endif; ?>
            <?php if(auth()->guard()->guest()): ?>
                <a href="<?php echo e(route('register')); ?>" class="btn btn-sm btn-primary px-3 font-weight-600">Ajouter Offre</a>
            <?php endif; ?>
        </div>
        <div class="row">
