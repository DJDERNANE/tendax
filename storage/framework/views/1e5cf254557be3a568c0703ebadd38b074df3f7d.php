                ...
                <div class="col-4">
                    <div class="col-12">
                        <div class="my-3">
                            ...
                            <img width="200" height="100" class=" my-2" src="<?php echo e(asset('pictures/Products/'.$product->picture)); ?>" alt="photo">
                        ...
                        <div>
                            ...
                            <img width="80" height="80" class=" m-2" src="<?php echo e(asset('pictures/Products/pictures/'.$product->picture.'/'.$item->path)); ?>" alt="photo">
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.storepanel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tendaxe\resources\views/store/panel/detailsProduct.blade.php ENDPATH**/ ?>