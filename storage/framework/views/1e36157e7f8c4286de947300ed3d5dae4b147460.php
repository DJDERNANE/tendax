...
<?php $__env->startSection('content'); ?>
	<div class="container main">
		...
		<form class="bg-white border px-4 pt-3 mx-auto mb-5 rounded" style="max-width: 360px" method="POST" action="<?php echo e(route('login')); ?>">
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tendaxe\resources\views/auth/login.blade.php ENDPATH**/ ?>