        ...
        <div class="row">
                            ...
                            <tr>
                                <td class="d-flex  justify-content-start">
                                    <img class="col-3 shadow-sm bg-white" width="40" height="100"
                                        src="<?php echo e(asset('img/PRO.png')); ?>" alt="payement methode">
                                    <div>
            ...
            <div class="col-4  p-0">
                ...
                <div class="rounded-3 bg-white client-info my-3 p-3 d-flex justify-content-center">
                    <button class="col-12 px-2 primary py-2 rounded-3 border-0"> <img src="<?php echo e(asset('img/icons/bon.png')); ?>"
                ...
                <div class="rounded-3 bg-white client-info ">
                    <div class="d-flex justify-content-between align-items-center px-2">
                        ...
                        <button class="bg-transparent border-0">
                            <img src="<?php echo e(asset('img/icons/note.png')); ?>" alt="Note" height="22">
                        </button>
...
<?php echo $__env->make('layouts.storepanel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tendaxe\resources\views/store/panel/confirmOrder.blade.php ENDPATH**/ ?>