    ...
    <section class="container my-5">
        <div class="row mx-0">
            <div class="col-md-4 px-md-0">
                <div class="mb-3">
                    <div class="d-flex align-items-center">
                        <img src="<?php echo e(asset('img/icons/Vector.png')); ?>" width="30px" height="40px">
                ...
                <div class="mb-3">
                    <div class="d-flex align-items-center">
                        <img src="<?php echo e(asset('img/icons/Vector (1).png')); ?>" width="30px" height="40px">
                ...
                <div class="mb-3">
                    <div class="d-flex align-items-center">
                        <img src="<?php echo e(asset('img/icons/Vector (2).png')); ?>" width="30px" height="40px">
            ...
            <div class="col-md-4 d-flex align-items-center justify-content-center my-2">
                <img class="img-fluid" src="<?php echo e(asset('img/figure1.png')); ?>">
            </div>
            <div class="col-md-4 px-md-0">
                <div class="mb-3">
                    <div class="d-flex align-items-center">
                        <img src="<?php echo e(asset('img/icons/Vector (3).png')); ?>" width="30px" height="40px">
                ...
                <div class="mb-3">
                    <div class="d-flex align-items-center">
                        <img src="<?php echo e(asset('img/icons/Vector1.png')); ?>" width="30px" height="40px">
                ...
                <div class="mb-3">
                    <div class="d-flex align-items-center">
                        <img src="<?php echo e(asset('img/icons/Vector (4).png')); ?>" width="30px" height="40px">
        ...
        <div class=" d-flex flex-column align-items-center">
            ...
            <div class="my-5 tendax-store-section">
                ...
                <div class="container my-4">
                    ...
                    <div class="my-4">
                        <p>
                            <img src="<?php echo e(asset('img/icons/start.png')); ?>" alt="image" class="mr-2"> Soyez guidés par
                            nos experts
                        </p>
                        <p>
                            <img src="<?php echo e(asset('img/icons/annaux.png')); ?>" alt="image" class="mr-2"> Pour toutes les
                            organismes
                        </p>
                        <p>
                            <img src="<?php echo e(asset('img/icons/24.png')); ?>" alt="image" class="mr-2"> Devis en 24 heurs
                        </p>
                        <p>
                            <img src="<?php echo e(asset('img/icons/card.png')); ?>" alt="image" class="mr-2"> Commandez vos
                            articles
                        </p>
...
<?php endif; ?>
        ...
        <div class="text-right">
            <a href="<?php echo e(route('search')); ?>" class="btn btn-primary font-weight-600">Tous les appels d’offre <img
                    class="pl-4" src="<?php echo e(asset('img/icons/arrow.png')); ?>"></a>
        </div>
    </section>
    ...
    <script type="text/javascript">
        ...
        // $("#custom-toggle-icon").attr("src", "<?php echo e(asset('img/icons/navbar_button_light.png')); ?>");
        ...
        //         $("#custom-toggle-icon").attr("src", "<?php echo e(asset('img/icons/navbar_button_dark.png')); ?>");
        ...
        function demander_pack(e) {
            ...
            $.ajax({
                type: 'post',
                url: "<?php echo e(route('user.pack.add')); ?>",
                data: {
