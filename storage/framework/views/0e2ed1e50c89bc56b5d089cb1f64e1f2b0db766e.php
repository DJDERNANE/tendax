    ...
    <div class="mt-md-5 pt-md-5 mt-5 container">
        ...
        <div class="container">
            <div class="my-md-5 my-2 marques ">
                ...
                <a class="boutique-card shadow rounded" href="<?php echo e(route('store.show', $item->id)); ?>">
...
<?php echo $__env->make('layouts.storelayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tendaxe\resources\views/store/allStores.blade.php ENDPATH**/ ?>