...
<?php $__env->startSection('title', 'Sous-sous-Categories'); ?>
    ...
    <div class="container my-5 pt-5">
        <div  class="d-flex justify-content-between align-items-center">
            <div class="d-flex">
                ...
                <h6><a href="<?php echo e(route('subcategories.all')); ?>" >SubCategories</a> </h6>
                <h6><a href="<?php echo e(route('subsubcategories.all')); ?>" class="ms-2 active">SubSubCategories <span id="count2"></span></a> </h6>
            </div>
            <div>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form  class="  store-form align-items-center p-2 rounded-3" method="post" action="<?php echo e(route('subsubcategories.store')); ?>" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
        ...
        <table class="table text-center ">
            ...
            <tbody>
            <?php $__currentLoopData = $subSubCats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                ...
                <td> <?php echo e($item->subCategory->category->name); ?></td>
              </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.adminStorePanel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tendaxe\resources\views/admin/store/subSubCategories.blade.php ENDPATH**/ ?>